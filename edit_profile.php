...
<tr>
     ...
     <td>
          <input class="form-control input-md" type="date" max='2010-01-01' name="u_birthday" required value="<?php echo $user_birthday;?>">          
</td>
</tr> 
...
if(isset($_POST['update'])){
     ...
     user_name='$u_name',describe_user='$describe_user',Relationship='$Relationship_status',user_country='$u_country',user_gender='$u_gender',
