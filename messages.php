...
?>
 ...
 <div class="col-sm-3" id="select_user">
     <?php
       $user ="select * from users where user_email !='$user'";
...
?>
   ...
   if(isset($_POST['send_msg'])){
    ...
    if($msg== ""){
echo "<h4 style='color:red;trxt-align:center;'>Message was unable to send!</h4>";
    }
    else if(strlen($msg)>50){
      echo "<h4 style='color:red;trxt-align:center;'>Message is too long to be send! Only 50 character allowed</h4>";
          }
          else{
...
if($get_id=="new"){
  ...
  <br><br>
  <ul class='list-group'>
  <li class='list-group-item' title='Username'><strong> $first_name
  $last_name</strong></li>
  <li class='list-group-item' style='color:grey;' title='User Status'><strong>$describe_user </strong></li>
  <li class='list-group-item' style='color:grey;' title='Gender'>$gender</li>
  <li class='list-group-item' style='color:grey;' title='Country'>$user_country</li>
  <li class='list-group-item' style='color:grey;' title='Registration Date'> $register_date</li>
  </ul>
  </div>
