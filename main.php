...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white; font-weight: bold;">SocialShout</h1></center>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6" style="left:0.5%;">
			<img src="images/cov.jpg" class="img-rounded" title="SocialShout" width="650px" height="565px">
		...
		<div class="col-sm-6" style="left:8%:">
			<img src="images/logo.png" class="img-rounded" title="SocialShout" width="140px" height="120px">
			<h2><strong>See what's happening in <br> the world right now</strong></h2><br><br>
			<h4><strong>Join SocialShout Today.</strong></h4>
